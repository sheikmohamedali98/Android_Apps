...
public class FragmentHomeBindingImpl extends FragmentHomeBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.example.miniyoutube.viewmodel.HomeViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.example.miniyoutube.viewmodel.HomeViewModel ViewModel) {
